(function(require$$0, react) {
  ...
  const StatisticsItem = createAndRegisterRemoteReactComponent("StatisticsItem");
  const Statistics = createAndRegisterRemoteReactComponent("Statistics");
  ...
  hubspot.extend(({ context, actions }) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(DuplicateAuditCard, { context, actions }, void 0, false, {
    fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
    lineNumber: 11,
    columnNumber: 3
  }, void 0));
  const DuplicateAuditCard = ({ context, actions }) => {
    var _a, _b;
    ...
    const [pollCount, setPollCount] = require$$0.useState(0);
    const [dismissed, setDismissed] = require$$0.useState([]);
    const [merging, setMerging] = require$$0.useState(null);
    const [userMaster, setUserMaster] = require$$0.useState({});
    const contactId = String(((_a = context == null ? void 0 : context.crm) == null ? void 0 : _a.objectId) || "unknown");
    const runAudit = async () => {
      ...
      try {
        const res = await hubspot.fetch(`${BACKEND_URL}/start-job`, {
          method: "POST",
          body: JSON.stringify({ records: [{ id: contactId }] })
        });
    ...
    const pollForResult = async (id, attempt) => {
      ...
      try {
        ...
        if (data.status === "error") {
          setError(data.message || "Worker failed");
          setStatus("error");
          return;
        }
    ...
    const handleMerge = async (primaryId, duplicateId, primaryName, duplicateName) => {
    ...
    const visibleClusters = ((_b = result == null ? void 0 : result.clusters) == null ? void 0 : _b.filter(
      (c) => !dismissed.includes(c.cluster_ids.join(","))
    )) || [];
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "md", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Heading, { children: "Duplicate Audit Copilot" }, void 0, false, {
        fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
        lineNumber: 105,
        columnNumber: 7
      }, void 0),
      ...
      status === "idle" && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "sm", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: "Scans all contacts and finds duplicates using email, phone, and name matching. You choose which record to keep." }, void 0, false, {
          fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
          lineNumber: 111,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Button, { onClick: runAudit, variant: "primary", children: "Run Duplicate Audit" }, void 0, false, {
          fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
          lineNumber: 115,
          columnNumber: 11
        }, void 0)
      ...
      (status === "starting" || status === "polling") && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", align: "center", gap: "sm", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        LoadingSpinner,
        {
          label: status === "starting" ? "Starting audit..." : `Scanning contacts... (${pollCount}/20)`
        },
        void 0,
        false,
        {
      ...
      status === "error" && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "sm", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Alert, { title: "Audit failed", variant: "error", children: error }, void 0, false, {
          fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
          lineNumber: 137,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Button, { onClick: runAudit, variant: "secondary", children: "Try Again" }, void 0, false, {
          fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
          lineNumber: 138,
          columnNumber: 11
        }, void 0)
      ...
      status === "done" && result && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "md", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Statistics, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          StatisticsItem,
          {
        ...
        result.total_records_scanned && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: [
        ...
        visibleClusters.length === 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", align: "center", gap: "sm", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { format: { fontWeight: "bold" }, children: "No duplicates found — your CRM is clean!" }, void 0, false, {
            fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
            lineNumber: 161,
            columnNumber: 15
          }, void 0),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Button, { onClick: runAudit, variant: "secondary", size: "xs", children: "Re-run Audit" }, void 0, false, {
            fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
            lineNumber: 164,
            columnNumber: 15
          }, void 0)
        ...
        visibleClusters.map((cluster, idx) => {
          ...
          const masterRecord = (_a2 = cluster.records) == null ? void 0 : _a2.find((r) => r.id === masterId);
          return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Tile, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "sm", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { justify: "between", align: "center", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Tag, { variant, children: [
                (conf * 100).toFixed(0),
                "% match"
              ] }, void 0, true, {
                fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
            ...
            ((_b2 = cluster.reasons) == null ? void 0 : _b2.length) > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "xs", children: cluster.reasons.map((reason, i) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: [
              "• ",
              reason
            ] }, i, true, {
              fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { format: { italic: true }, children: "Select which record to keep, then merge the duplicate into it." }, void 0, false, {
              fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
              lineNumber: 206,
              columnNumber: 19
            }, void 0),
            (_c = cluster.records) == null ? void 0 : _c.map((rec, recIdx) => {
              const isCurrentMaster = rec.id === masterId;
              return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "xs", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { justify: "between", align: "center", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { format: { fontWeight: "demibold" }, children: rec.name || "Unknown Name" }, void 0, false, {
                    fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
                    lineNumber: 218,
                    columnNumber: 27
                  }, void 0),
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Tag, { variant: isCurrentMaster ? "success" : "default", children: isCurrentMaster ? "Will Keep" : "Will Remove" }, void 0, false, {
                    fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
                    lineNumber: 221,
                    columnNumber: 27
                  }, void 0)
                ...
                rec.email && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: [
                  "Email: ",
                  rec.email
                ] }, void 0, true, {
                  fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
                ...
                rec.phone && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: [
                  "Phone: ",
                  rec.phone
                ] }, void 0, true, {
                  fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
                ...
                rec.company && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: [
                  "Company: ",
                  rec.company
                ] }, void 0, true, {
                  fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
                ...
                !isCurrentMaster && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                  Button,
                  {
                    onClick: () => setUserMaster((prev) => ({
                      ...prev,
                      [clusterKey]: rec.id
                    })),
                    variant: "secondary",
                    size: "xs",
                    children: "Set as Master (keep this one instead)"
                  },
                  void 0,
                  false,
                  {
                ...
                !isCurrentMaster && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                  Button,
                  {
                    onClick: () => handleMerge(
                      masterId,
                      rec.id,
                      (masterRecord == null ? void 0 : masterRecord.name) || masterId,
                      rec.name || rec.id
                    ),
                    variant: "destructive",
                    size: "xs",
                    disabled: merging === rec.id,
                    children: merging === rec.id ? "Merging..." : `Merge "${rec.name || rec.id}" into "${(masterRecord == null ? void 0 : masterRecord.name) || masterId}"`
                  },
                  void 0,
                  false,
                  {
                ...
                recIdx < cluster.records.length - 1 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Divider, {}, void 0, false, {
                  fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
                  lineNumber: 269,
                  columnNumber: 65
                }, void 0)
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              Button,
              {
                onClick: () => setDismissed((prev) => [...prev, clusterKey]),
                variant: "secondary",
                size: "xs",
                children: "Not a duplicate — dismiss"
              },
              void 0,
              false,
              {
        ...
        visibleClusters.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Button, { onClick: runAudit, variant: "secondary", size: "xs", children: "Re-run Audit" }, void 0, false, {
          fileName: "C:/Users/krish/Downloads/duplicate-audit-copilot/Duplicate_Audit/src/app/cards/NewCard.tsx",
          lineNumber: 293,
          columnNumber: 13
        }, void 0)
